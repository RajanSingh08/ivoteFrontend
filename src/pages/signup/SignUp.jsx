...
const Register = () => {
  ...
  const fetchOrganizations = async () => {
    ...
    await axios.get("https://ivotebackend.onrender.com/organizations").then((res) => {
      let orgs = []
      res.data.map((org) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (handleValidation()) {
      ...
      if(formData.role === "Voter"){
        ...
        await axios.post("https://ivotebackend.onrender.com/organization-register", formData).then(
          (res) => {
            localStorage.setItem('userId', res.data._id);
            localStorage.setItem('role', res.data.role);
            localStorage.setItem('username', res.data.username);
        ...
        await axios.post("https://ivotebackend.onrender.com/admin-register", formData).then(
          (res) => {
            localStorage.setItem('userId', res.data._id);
            localStorage.setItem('role', res.data.role);
            localStorage.setItem('username', res.data.username);
