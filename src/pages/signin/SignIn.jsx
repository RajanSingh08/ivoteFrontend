  ...
  const handleSubmit = async (e) => {
    ...
    if (handleValidation()) {
      ...
      if(formData.role === "Voter"){
        await axios.post("https://ivotebackend.onrender.com/user-login", formData).then(
          (res) => {
        ...
        await axios.post("https://ivotebackend.onrender.com/organization-login", formData).then(
          (res) => {
            localStorage.setItem('userId', res.data._id);
            localStorage.setItem('role', res.data.role);
            localStorage.setItem('username', res.data.username);
        ...
        await axios.post("https://ivotebackend.onrender.com/admin-login", formData).then(
          (res) => {
            localStorage.setItem('userId', res.data._id);
            localStorage.setItem('role', res.data.role);
            localStorage.setItem('username', res.data.username);
